...
/**
 * The Interface ICIPMLAgentsRepositoryMYSQL.
 */
@Profile("mysql")
@Repository
public interface ICIPMLAIWorkerConfigRepositoryMYSQL extends ICIPMLAIWorkerConfigRepository{
	...
	ICIPMLAIWorkerConfig getAllAIWorkerConfigByOrg(@Param("name")String name, @Param("project")String project);
	
	@Query(value="SELECT DISTINCT jt.name "
			+ "FROM mlaiworkerconfig t, "
			+ "JSON_TABLE(task_group, '$[*].bots[*]' COLUMNS ("
