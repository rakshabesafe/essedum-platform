...
public interface ICPMLFederatedModelsDSRepository extends JpaRepository<ICIPMLFederatedModelDS, Integer> {
	...
	List<ICIPMLFederatedModelDS> getAllDistinctModelsByOrganisation(@Param("org") String organization, @Param("search") String search, Pageable page);
	...
	@Query("SELECT new com.lfn.icip.icipwebeditor.model.dto.ICIPDatasourceFilterDTO(model.datasource.name, model.datasource.alias) " +
