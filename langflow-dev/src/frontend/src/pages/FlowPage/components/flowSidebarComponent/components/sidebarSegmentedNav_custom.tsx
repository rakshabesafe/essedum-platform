...
const SidebarSegmentedNavCustom = () => {
              ...
              <ShadTooltip content={item.tooltip} side="right">
                <SidebarMenuButton
                  ...
                  className={cn(
                    ...
                    // CUSTOM: Remove the highlighting by using the same style for active and inactive
                    "text-muted-foreground hover:bg-gray-100 hover:text-gray-700",
                    // Optional: Add a subtle border for active state instead of background color
...
export default SidebarSegmentedNavCustom;