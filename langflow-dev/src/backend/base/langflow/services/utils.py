...
async def teardown_services() -> None:
    ...
    # Teardown MySQL MCP service
    try:
        from langflow.services.mcp import stop_mysql_mcp_service
        await stop_mysql_mcp_service()
    except Exception as e:
        from lfx.log import logger
        await logger.awarning(f"Failed to stop MySQL MCP service: {e}")
